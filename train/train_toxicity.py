"""
Contextual Toxicity Classifier Training Engine.
Trains a sequence classification transformer on direct toxicity, reframed hostility, and safe dev commands.
"""
...
MODELS_DIR = ROOT_DIR / "models" / "toxicity_roberta"
MODELS_DIR.mkdir(parents=True, exist_ok=True)

from train.training_data import TOXICITY_DATASET
...
def train():
    ...
    print(f"Training Contextual Toxicity Classifier on device: {str(device).upper()}")
