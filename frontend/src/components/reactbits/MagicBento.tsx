...
const defaultCardData: BentoCardItem[] = [
  {
    color: '#0E0F12',
    title: 'Zero-Trust Ingress Guard',
    description: 'Sub-millisecond prompt injection, jailbreak, and secret scanner',
    label: 'PERIMETER'
  },
  {
    color: '#0E0F12',
    title: 'Semantic Vector Matcher',
    description: '384-d all-MiniLM-L6-v2 embedding router with cosine alignment',
    label: 'ROUTING'
  },
  {
    color: '#0E0F12',
    title: 'Self-Healing Immune Loop',
    description: 'Automated threshold divergence proposals and statistical calibration',
    label: 'AUTONOMOUS'
  },
  {
    color: '#0E0F12',
    title: 'Zero-Plaintext Secret Vault',
    description: 'Volatile-memory HMAC-SHA256 fingerprint matching without persistence',
    label: 'ENCRYPTION'
  },
  {
    color: '#0E0F12',
    title: 'Granular PII Matrix',
    description: 'Strict allow/block governance for SSN, PAN, emails, and IBAN records',
    label: 'COMPLIANCE'
  },
  {
    color: '#0E0F12',
    title: 'Cryptographic Audit Ledger',
    description: 'Immutable SHA-256 ingress and egress verification hashes',
    label: 'FORENSICS'
  }
];
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
          ...
          const cardProps = {
            ...
            style: {
              backgroundColor: card.color || '#0E0F12',
